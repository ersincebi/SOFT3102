...
public class EditTripDriverActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    /**
     * driver edit trip page
     * activity constructor
     * also takes userID and objectID by intent
     * and makes button handling date and time selector
