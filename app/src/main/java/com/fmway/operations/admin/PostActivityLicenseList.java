...
import java.util.ArrayList;
    ...
    public class PostActivityLicenseList extends ArrayAdapter<String> {
        ...
        public PostActivityLicenseList (ArrayList<String> username,ArrayList<String> userComment,ArrayList<Bitmap> userImage,Activity context) {
